 ...
 */
 void keyboard(int code){
    switch(code){
        ...
        case 99:
        click = !click;
        if(mouse) cout << "     Clicking Activated" << endl;
        ...
        drag = !drag;
            if(mouse) cout << "     Drag Activated" << endl;
